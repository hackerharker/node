...
support features such as optional file extensions or JSON modules that the
Node.js ESM implementation does not support. It is highly likely that modules
from transpiled environments will require a certain degree of refactoring to
work in Node.js. It is worth mentioning that many of our design decisions were
made with two primary goals. Spec compliance and Web Compatibility. It is our
belief that the current implementation offers a future proof model to authoring
ESM modules that paves the path to Universal JavaScript. Please read more in
our documentation.
...
* [[`d288a52a9f`](https://github.com/nodejs/node/commit/d288a52a9f)] - **(SEMVER-MINOR)** **console**: support console constructor groupIndentation option (rickyes) [#32964](https://github.com/nodejs/node/pull/32964)
...
* [[`f9edab1a22`](https://github.com/nodejs/node/commit/f9edab1a22)] - **(SEMVER-MINOR)** **esm**: unflag --experimental-modules (Guy Bedford) [#29866](https://github.com/nodejs/node/pull/29866)
...
* [[`6a6d58bd7f`](https://github.com/nodejs/node/commit/6a6d58bd7f)] - **build**: add --error-on-warn configure flag (Daniel Bevenius) [#32685](https://github.com/nodejs/node/pull/32685)
...
* [[`eba1772bbf`](https://github.com/nodejs/node/commit/eba1772bbf)] - **cluster**: fix error on worker disconnect/destroy (Santiago Gimeno) [#32793](https://github.com/nodejs/node/pull/32793)
...
* [[`ff70ecb1da`](https://github.com/nodejs/node/commit/ff70ecb1da)] - **crypto**: check DiffieHellman p and g params (Ben Noordhuis) [#32739](https://github.com/nodejs/node/pull/32739)
* [[`22c08cdc9d`](https://github.com/nodejs/node/commit/22c08cdc9d)] - **crypto**: generator must be int32 in DiffieHellman() (Ben Noordhuis) [#32739](https://github.com/nodejs/node/pull/32739)
* [[`adfa4695b0`](https://github.com/nodejs/node/commit/adfa4695b0)] - **crypto**: key size must be int32 in DiffieHellman() (Ben Noordhuis) [#32739](https://github.com/nodejs/node/pull/32739)
...
* [[`688076d0e3`](https://github.com/nodejs/node/commit/688076d0e3)] - **deps**: update to uvwasi 0.0.8 (Colin Ihrig) [#33078](https://github.com/nodejs/node/pull/33078)
...
* [[`868d49b64d`](https://github.com/nodejs/node/commit/868d49b64d)] - **http**: simplify sending header (Robert Nagy) [#33200](https://github.com/nodejs/node/pull/33200)
...
* [[`e36246ad1d`](https://github.com/nodejs/node/commit/e36246ad1d)] - **lib**: cosmetic change to builtinLibs list for maintainability (James M Snell) [#33106](https://github.com/nodejs/node/pull/33106)
* [[`c822f12f0e`](https://github.com/nodejs/node/commit/c822f12f0e)] - **lib**: fix validateport error message when allowZero is false (rickyes) [#32861](https://github.com/nodejs/node/pull/32861)
* [[`233b988d1d`](https://github.com/nodejs/node/commit/233b988d1d)] - **lib**: add warning on dynamic import es modules (Juan José Arboleda) [#30720](https://github.com/nodejs/node/pull/30720)
...
* [[`2312e5fa07`](https://github.com/nodejs/node/commit/2312e5fa07)] - **module**: no type module resolver side effects (Guy Bedford) [#33086](https://github.com/nodejs/node/pull/33086)
* [[`3b9b2785be`](https://github.com/nodejs/node/commit/3b9b2785be)] - **module**: partial doc removal of --experimental-modules (Myles Borins) [#32915](https://github.com/nodejs/node/pull/32915)
...
* [[`72bca64f46`](https://github.com/nodejs/node/commit/72bca64f46)] - **n-api**: simplify uv\_idle wrangling (Ben Noordhuis) [#32997](https://github.com/nodejs/node/pull/32997)
...
* [[`07bfaaddcf`](https://github.com/nodejs/node/commit/07bfaaddcf)] - **path**: fix comment grammar (thecodrr) [#32942](https://github.com/nodejs/node/pull/32942)
...
* [[`02c7a97945`](https://github.com/nodejs/node/commit/02c7a97945)] - **src**: remove unused v8 Message namespace (Adrian Estrada) [#33180](https://github.com/nodejs/node/pull/33180)
* [[`8d3f978167`](https://github.com/nodejs/node/commit/8d3f978167)] - **src**: use unique\_ptr for CachedData in ContextifyScript::New (Anna Henningsen) [#33113](https://github.com/nodejs/node/pull/33113)
* [[`b45c881bb6`](https://github.com/nodejs/node/commit/b45c881bb6)] - **src**: return undefined when validation err == 0 (James M Snell) [#33107](https://github.com/nodejs/node/pull/33107)
* [[`4562d4b8df`](https://github.com/nodejs/node/commit/4562d4b8df)] - **src**: crypto::UseSNIContext to use BaseObjectPtr (James M Snell) [#33107](https://github.com/nodejs/node/pull/33107)
* [[`9350315f74`](https://github.com/nodejs/node/commit/9350315f74)] - **src**: separate out NgLibMemoryManagerBase (James M Snell) [#33104](https://github.com/nodejs/node/pull/33104)
* [[`3e24c7522b`](https://github.com/nodejs/node/commit/3e24c7522b)] - **src**: remove unnecessary fully qualified names (rickyes) [#33077](https://github.com/nodejs/node/pull/33077)
...
* [[`c2898f393b`](https://github.com/nodejs/node/commit/c2898f393b)] - **stream**: add null check in Readable.from (Pranshu Srivastava) [#32873](https://github.com/nodejs/node/pull/32873)
* [[`34ec17a500`](https://github.com/nodejs/node/commit/34ec17a500)] - **stream**: close iterator in Readable.from (Vadzim Zieńka) [#32844](https://github.com/nodejs/node/pull/32844)
...
* [[`8b4c57f8b8`](https://github.com/nodejs/node/commit/8b4c57f8b8)] - **vm**: throw error when duplicated exportNames in SyntheticModule (himself65) [#32810](https://github.com/nodejs/node/pull/32810)
...
* [[`8b7ff1c03e`](https://github.com/nodejs/node/commit/8b7ff1c03e)] - **wasi**: use free() to release preopen array (Anna Henningsen) [#33110](https://github.com/nodejs/node/pull/33110)
* [[`49df7fa630`](https://github.com/nodejs/node/commit/49df7fa630)] - **wasi**: update start() behavior to match spec (Colin Ihrig) [#33073](https://github.com/nodejs/node/pull/33073)
* [[`dd8002279e`](https://github.com/nodejs/node/commit/dd8002279e)] - **wasi**: rename \_\_wasi\_unstable\_reactor\_start() (Colin Ihrig) [#33073](https://github.com/nodejs/node/pull/33073)
...
* [[`e33f2da7b5`](https://github.com/nodejs/node/commit/e33f2da7b5)] - **doc**: fix a typo in crypto.generateKeyPairSync() (himself65) [#33187](https://github.com/nodejs/node/pull/33187)
* [[`09a7a4ecd2`](https://github.com/nodejs/node/commit/09a7a4ecd2)] - **doc**: add util.types.isArrayBufferView() (Kevin Locke) [#33092](https://github.com/nodejs/node/pull/33092)
* [[`15ca2fb72b`](https://github.com/nodejs/node/commit/15ca2fb72b)] - **doc**: clarify when not to run CI on docs (Juan José Arboleda) [#33101](https://github.com/nodejs/node/pull/33101)
* [[`b74afc67c0`](https://github.com/nodejs/node/commit/b74afc67c0)] - **doc**: fix the spelling error in stream.md (白一梓) [#31561](https://github.com/nodejs/node/pull/31561)
* [[`e4b17e95f4`](https://github.com/nodejs/node/commit/e4b17e95f4)] - **doc**: correct Nodejs to Node.js spelling (Nick Schonning) [#33088](https://github.com/nodejs/node/pull/33088)
* [[`9dc9c0966f`](https://github.com/nodejs/node/commit/9dc9c0966f)] - **doc**: improve worker pool example (Ranjan Purbey) [#33082](https://github.com/nodejs/node/pull/33082)
* [[`6782b1dffa`](https://github.com/nodejs/node/commit/6782b1dffa)] - **doc**: some grammar fixes (Chris Holland) [#33081](https://github.com/nodejs/node/pull/33081)
* [[`d1379331d6`](https://github.com/nodejs/node/commit/d1379331d6)] - **doc**: don't check links in tmp dirs (Ben Noordhuis) [#32996](https://github.com/nodejs/node/pull/32996)
...
* [[`4bcc8aff6a`](https://github.com/nodejs/node/commit/4bcc8aff6a)] - **test**: update c8 ignore comment (Benjamin Coe) [#33151](https://github.com/nodejs/node/pull/33151)
* [[`31f86f63cd`](https://github.com/nodejs/node/commit/31f86f63cd)] - **test**: skip memory usage tests when ASAN is enabled (Anna Henningsen) [#33129](https://github.com/nodejs/node/pull/33129)
* [[`9d92a11d59`](https://github.com/nodejs/node/commit/9d92a11d59)] - **test**: move test-process-title to sequential (Anna Henningsen) [#33150](https://github.com/nodejs/node/pull/33150)
* [[`5ed8bbea9d`](https://github.com/nodejs/node/commit/5ed8bbea9d)] - **test**: fix out-of-bound reads from invalid sizeof usage (Anna Henningsen) [#33115](https://github.com/nodejs/node/pull/33115)
* [[`6c4c5d7ad0`](https://github.com/nodejs/node/commit/6c4c5d7ad0)] - **test**: add missing calls to napi\_async\_destroy (Anna Henningsen) [#33114](https://github.com/nodejs/node/pull/33114)
* [[`852ca0edb2`](https://github.com/nodejs/node/commit/852ca0edb2)] - **test**: check args on SourceTextModule cachedData (Juan José Arboleda) [#32956](https://github.com/nodejs/node/pull/32956)
* [[`fd7db6ab12`](https://github.com/nodejs/node/commit/fd7db6ab12)] - **test**: mark test flaky on freebsd (Sam Roberts) [#32849](https://github.com/nodejs/node/pull/32849)
* [[`086357ebf9`](https://github.com/nodejs/node/commit/086357ebf9)] - **test**: flaky test-stdout-close-catch on freebsd (Sam Roberts) [#32849](https://github.com/nodejs/node/pull/32849)
...
* [[`99f3e97c6b`](https://github.com/nodejs/node/commit/99f3e97c6b)] - **tools**: bump remark-preset-lint-node to 1.15.0 (Rich Trott) [#33157](https://github.com/nodejs/node/pull/33157)
* [[`8970d22ccc`](https://github.com/nodejs/node/commit/8970d22ccc)] - **tools**: fix redundant-move warning in inspector (Daniel Bevenius) [#32685](https://github.com/nodejs/node/pull/32685)
* [[`85c3488ce6`](https://github.com/nodejs/node/commit/85c3488ce6)] - **tools**: update remark-preset-lint-node@1.14.0 (Rich Trott) [#33072](https://github.com/nodejs/node/pull/33072)
* [[`9d7ce29892`](https://github.com/nodejs/node/commit/9d7ce29892)] - **tools**: update broken types in type parser (Colin Ihrig) [#33068](https://github.com/nodejs/node/pull/33068)
* [[`d072f08f72`](https://github.com/nodejs/node/commit/d072f08f72)] - **tools**: fix mkcodecache when run with ASAN (Anna Henningsen) [#32850](https://github.com/nodejs/node/pull/32850)
